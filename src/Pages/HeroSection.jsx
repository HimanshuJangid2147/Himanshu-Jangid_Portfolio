...
const NodeLogo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-12 h-12" viewBox="0 0 48 48">
...
const LaravelLogo = () => (
    <svg fill="#F05340" className="w-8 h-8" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
...
const PhpLogo = () => (
    <svg className="w-8 h-8" viewBox="0 -61 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
        <g fill-rule="evenodd">
...
const MySqlLogo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" viewBox="0 0 25.6 25.6">
...
const JsLogo = () => (
    <svg className="w-8 h-8" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
...
const HeroSection = () => {
    ...
    // Tech stack updated with real logo components
    const techStack = [
                ...
                <motion.div variants={itemVariants}>
                    <div className="mb-8">
                        ...
                        <div className="grid grid-cols-4 lg:grid-cols-8 gap-4 max-w-4xl mx-auto">
                            {techStack.map((tech) => {
                                // This check is needed if you pass component names as strings
                                const LogoComponent = tech.LogoComponent ? eval(tech.LogoComponent) : LogoPlaceholder;
                                return (
